...
public class Partido {
	...
	//Función toString para comprobar si los partidos se han jugado y mostrarlos en caso de que no 
	@Override
	...
	//FUnción que compara las caracteristicas de los jugadores, equipos y entrenadores y realiza un cálculo para simular los partidos de manera equitativa
	public void simular() {
