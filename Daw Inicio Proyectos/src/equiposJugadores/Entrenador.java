...
/**
 * Clase Entrenador.
 * Esta clase extiende de la clase Descripción y además asignaremos a cada 
...
public class Entrenador extends Persona{
    ...
    private float potPrecision; //Aqui guardamos el potenciador de precisión del entrenador.
    private float potTecnica; //Aqui guardamos el potenciador de técnica del entrenador.
    ...
    public String toString() {
        return  "\n"+
                ...
                +"Potenciador de precisión: "+this.getPotPrecision()+"\n"
                +"Potenciador de técnica: "+this.getPotTecnica()+"\n";
    }
